...
export const MAIN_MENU_ICONS = deepPublicAssets({
  ...
  register: '/assets/menu/Register.png',
  account: '/assets/menu/Account.png',
  logout: '/assets/menu/Logout.png',
  monolithArchive: '/assets/menu/Monolith_Archive.png',
  leaderboard: '/assets/menu/Leaderboard.png',
  friendlyBattle: '/assets/menu/Friendly_Battle.png',
...
export const MAIN_MENU_TEXT = deepPublicAssets({
  ...
  login: '/assets/menu/Login_Text.png',
  register: '/assets/menu/Register_Text.png',
  account: '/assets/menu/Account_Text.png',
  logout: '/assets/menu/Logout_Text.png',
  monolithArchive: '/assets/menu/Monolith_Archive_Text.png',
  leaderboard: '/assets/menu/Leaderboard_Text.png',
  friendlyBattle: '/assets/menu/Friendly_Battle_Text.png',
